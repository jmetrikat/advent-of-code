...
int part_1(char input_file[]) {
    ...
    if (fp != NULL) {
        ...
        int *distance = (int *)malloc(sizeof(int) * no_nodes);
        int *visited = (int *)malloc(sizeof(int) * no_nodes);
        int **cost = (int **)malloc(sizeof(int *) * no_nodes);
        ...
        distance[start[0] + start[1] * col] = 0;
